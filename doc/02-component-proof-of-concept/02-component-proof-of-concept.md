...
I think musicDatabase would be the best component to implement, as it's something I've been wanting to make for a while, would be pretty useful once made (and even more so once it is eventually expanded to scan music services like spotify or youtube music, but that's beyond the scope of this project), and is reasonably challenging to make.
